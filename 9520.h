...
// MFS_14BITS or MFS_16BITS, 14-bit or 16-bit magnetometer resolution
uint8_t Mscale = MFS_16BITS;
// Either 8 Hz 0x02) or 100 Hz (0x06) magnetometer data ODR
uint8_t Mmode = 0x06;
...
class MPU9250 {
    ...
    public:
        ...
        /**
         * Scale the variable according to format
         */
        void getMres() {
            switch (Mscale)
            {
